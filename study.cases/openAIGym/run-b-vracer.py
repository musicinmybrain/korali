...
parser.add_argument('--nSamples', help='Number of Samples from Posterior that are used to approximate posterior predicitve distribution.', required=False, type=int, default = 5)
parser.add_argument('--nHyperparameters', help='Number of Hyperparameters that are stored.', required=False, type=int, default = 5)
parser.add_argument('--bSWAG', help='Boolean to decide whether we use SWAG.', required=False, type=bool, default=True)
...
e["Solver"]["Gaussian Approximation"]["Type"] = "Average"

# Setting for minimal approximation
e["Solver"]["Minimal Approximation"] = False
