...
srun --nodes=$NODES --ntasks-per-node=12 --cpus-per-task=1 --threads-per-core=1 ./run-vracer-cylinder -nRanks 12 : --nodes=1 --ntasks-per-node=1 --cpus-per-task=12 --threads-per-core=1 ./run-vracer-cylinder -nRanks 12
EOF
