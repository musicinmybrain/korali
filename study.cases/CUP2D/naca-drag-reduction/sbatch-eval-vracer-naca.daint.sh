...
srun --nodes=$NNODES --ntasks-per-node=1 --cpus-per-task=12 --threads-per-core=1 ./eval-vracer-naca -nRanks $NRANKS : --nodes=1 --ntasks-per-node=1 --cpus-per-task=12 --threads-per-core=1 ./eval-vracer-naca -nRanks $NRANKS
EOF
