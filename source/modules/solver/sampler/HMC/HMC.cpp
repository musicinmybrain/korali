...
void HMC::setConfiguration(knlohmann::json& js) 
{
  ...
  if (isDefined(js, "Metric Type"))
  {
    try
    {
      _metricType = js["Metric Type"].get<Metric>();
 ...
 _uniformGenerator->setConfiguration(js["Uniform Generator"]);
  ...
  if (isDefined(js, "Acceptance Rate"))
  {
    try
    {
      _acceptanceRate = js["Acceptance Rate"].get<double>();
    } catch (const std::exception& e) {
      KORALI_LOG_ERROR(" + Object: [ HMC ] \n + Key:    ['Acceptance Rate']\n%s", e.what());
    }
  ...
  if (isDefined(js, "Running Acceptance Rate"))
  {
    try
    {
      _runningAcceptanceRate = js["Running Acceptance Rate"].get<double>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Acceptance Count"))
  {
    try
    {
      _acceptanceCount = js["Acceptance Count"].get<size_t>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Proposed Sample Count"))
  {
    try
    {
      _proposedSampleCount = js["Proposed Sample Count"].get<size_t>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Euclidean Warmup Sample Database"))
  {
    try
    {
      _euclideanWarmupSampleDatabase = js["Euclidean Warmup Sample Database"].get<std::vector<std::vector<double>>>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Sample Evaluation Database"))
  {
    try
    {
      _sampleEvaluationDatabase = js["Sample Evaluation Database"].get<std::vector<double>>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Chain Length"))
  {
    try
    {
      _chainLength = js["Chain Length"].get<size_t>();
    } catch (const std::exception& e) {
      KORALI_LOG_ERROR(" + Object: [ HMC ] \n + Key:    ['Chain Length']\n%s", e.what());
    }
  ...
  if (isDefined(js, "Leader Evaluation"))
  {
    try
    {
      _leaderEvaluation = js["Leader Evaluation"].get<double>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Candidate Evaluation"))
  {
    try
    {
      _candidateEvaluation = js["Candidate Evaluation"].get<double>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Position Leader"))
  {
    try
    {
      _positionLeader = js["Position Leader"].get<std::vector<double>>();
    } catch (const std::exception& e) {
      KORALI_LOG_ERROR(" + Object: [ HMC ] \n + Key:    ['Position Leader']\n%s", e.what());
    }
  ...
  if (isDefined(js, "Position Candidate"))
  {
    try
    {
      _positionCandidate = js["Position Candidate"].get<std::vector<double>>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Momentum Leader"))
  {
    try
    {
      _momentumLeader = js["Momentum Leader"].get<std::vector<double>>();
    } catch (const std::exception& e) {
      KORALI_LOG_ERROR(" + Object: [ HMC ] \n + Key:    ['Momentum Leader']\n%s", e.what());
    }
  ...
  if (isDefined(js, "Momentum Candidate"))
  {
    try
    {
      _momentumCandidate = js["Momentum Candidate"].get<std::vector<double>>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Log Dual Step Size"))
  {
    try
    {
      _logDualStepSize = js["Log Dual Step Size"].get<double>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Acceptance Count NUTS"))
  {
    try
    {
      _acceptanceCountNUTS = js["Acceptance Count NUTS"].get<double>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Current Depth"))
  {
    try
    {
      _currentDepth = js["Current Depth"].get<size_t>();
    } catch (const std::exception& e) {
      KORALI_LOG_ERROR(" + Object: [ HMC ] \n + Key:    ['Current Depth']\n%s", e.what());
    }
  ...
  if (isDefined(js, "Acceptance Probability"))
  {
    try
    {
      _acceptanceProbability = js["Acceptance Probability"].get<double>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Acceptance Rate Error"))
  {
    try
    {
      _acceptanceRateError = js["Acceptance Rate Error"].get<double>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Metric"))
  {
    try
    {
      _metric = js["Metric"].get<std::vector<double>>();
    } catch (const std::exception& e) {
      KORALI_LOG_ERROR(" + Object: [ HMC ] \n + Key:    ['Metric']\n%s", e.what());
    }
  ...
  if (isDefined(js, "Inverse Metric"))
  {
    try
    {
      _inverseMetric = js["Inverse Metric"].get<std::vector<double>>();
    } catch (const std::exception& e) {
      KORALI_LOG_ERROR(" + Object: [ HMC ] \n + Key:    ['Inverse Metric']\n%s", e.what());
    }
  ...
  if (isDefined(js, "Use Diagonal Metric"))
  {
    try
    {
      _useDiagonalMetric = js["Use Diagonal Metric"].get<int>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Num Integration Steps"))
  {
    try
    {
      _numIntegrationSteps = js["Num Integration Steps"].get<size_t>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Max Integration Steps"))
  {
    try
    {
      _maxIntegrationSteps = js["Max Integration Steps"].get<size_t>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Use Adaptive Step Size"))
  {
    try
    {
      _useAdaptiveStepSize = js["Use Adaptive Step Size"].get<int>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Target Acceptance Rate"))
  {
    try
    {
      _targetAcceptanceRate = js["Target Acceptance Rate"].get<double>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Acceptance Rate Learning Rate"))
  {
    try
    {
      _acceptanceRateLearningRate = js["Acceptance Rate Learning Rate"].get<double>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Target Integration Time"))
  {
    try
    {
      _targetIntegrationTime = js["Target Integration Time"].get<double>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Adaptive Step Size Speed Constant"))
  {
    try
    {
      _adaptiveStepSizeSpeedConstant = js["Adaptive Step Size Speed Constant"].get<double>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Adaptive Step Size Stabilization Constant"))
  {
    try
    {
      _adaptiveStepSizeStabilizationConstant = js["Adaptive Step Size Stabilization Constant"].get<double>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Adaptive Step Size Schedule Constant"))
  {
    try
    {
      _adaptiveStepSizeScheduleConstant = js["Adaptive Step Size Schedule Constant"].get<double>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Max Depth"))
  {
    try
    {
      _maxDepth = js["Max Depth"].get<size_t>();
    } catch (const std::exception& e) {
      KORALI_LOG_ERROR(" + Object: [ HMC ] \n + Key:    ['Max Depth']\n%s", e.what());
    }
  ...
  if (isDefined(js, "Inverse Regularization Parameter"))
  {
    try
    {
      _inverseRegularizationParameter = js["Inverse Regularization Parameter"].get<double>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Max Fixed Point Iterations"))
  {
    try
    {
      _maxFixedPointIterations = js["Max Fixed Point Iterations"].get<size_t>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Step Size Jitter"))
  {
    try
    {
      _stepSizeJitter = js["Step Size Jitter"].get<double>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Initial Fast Adaption Interval"))
  {
    try
    {
      _initialFastAdaptionInterval = js["Initial Fast Adaption Interval"].get<size_t>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Final Fast Adaption Interval"))
  {
    try
    {
      _finalFastAdaptionInterval = js["Final Fast Adaption Interval"].get<size_t>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Initial Slow Adaption Interval"))
  {
    try
    {
      _initialSlowAdaptionInterval = js["Initial Slow Adaption Interval"].get<size_t>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Termination Criteria", "Max Samples"))
  {
    try
    {
      _maxSamples = js["Termination Criteria"]["Max Samples"].get<size_t>();
    } catch (const std::exception& e) {
 ...
 for (size_t i = 0; i < _k->_js["Variables"].size(); i++) { 
  if (isDefined(_k->_js["Variables"][i], "Initial Mean"))
  {
    try
    {
      _k->_variables[i]->_initialMean = _k->_js["Variables"][i]["Initial Mean"].get<double>();
    } catch (const std::exception& e) {
      KORALI_LOG_ERROR(" + Object: [ HMC ] \n + Key:    ['Initial Mean']\n%s", e.what());
    }
  ...
  if (isDefined(_k->_js["Variables"][i], "Initial Standard Deviation"))
  {
    try
    {
      _k->_variables[i]->_initialStandardDeviation = _k->_js["Variables"][i]["Initial Standard Deviation"].get<double>();
    } catch (const std::exception& e) {
