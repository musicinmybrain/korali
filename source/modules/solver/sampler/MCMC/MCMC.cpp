...
void MCMC::setConfiguration(knlohmann::json& js) 
{
 ...
 _uniformGenerator->setConfiguration(js["Uniform Generator"]);
  ...
  if (isDefined(js, "Cholesky Decomposition Covariance"))
  {
    try
    {
      _choleskyDecompositionCovariance = js["Cholesky Decomposition Covariance"].get<std::vector<double>>();
  ...
  if (isDefined(js, "Cholesky Decomposition Chain Covariance"))
  {
    try
    {
      _choleskyDecompositionChainCovariance = js["Cholesky Decomposition Chain Covariance"].get<std::vector<double>>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Chain Leader"))
  {
    try
    {
      _chainLeader = js["Chain Leader"].get<std::vector<double>>();
    } catch (const std::exception& e) {
      KORALI_LOG_ERROR(" + Object: [ MCMC ] \n + Key:    ['Chain Leader']\n%s", e.what());
    }
  ...
  if (isDefined(js, "Chain Leader Evaluation"))
  {
    try
    {
      _chainLeaderEvaluation = js["Chain Leader Evaluation"].get<double>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Chain Candidate"))
  {
    try
    {
      _chainCandidate = js["Chain Candidate"].get<std::vector<std::vector<double>>>();
    } catch (const std::exception& e) {
      KORALI_LOG_ERROR(" + Object: [ MCMC ] \n + Key:    ['Chain Candidate']\n%s", e.what());
    }
  ...
  if (isDefined(js, "Chain Candidates Evaluations"))
  {
    try
    {
      _chainCandidatesEvaluations = js["Chain Candidates Evaluations"].get<std::vector<double>>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Rejection Alphas"))
  {
    try
    {
      _rejectionAlphas = js["Rejection Alphas"].get<std::vector<double>>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Chain Mean"))
  {
    try
    {
      _chainMean = js["Chain Mean"].get<std::vector<double>>();
    } catch (const std::exception& e) {
      KORALI_LOG_ERROR(" + Object: [ MCMC ] \n + Key:    ['Chain Mean']\n%s", e.what());
    }
  ...
  if (isDefined(js, "Chain Covariance Placeholder"))
  {
    try
    {
      _chainCovariancePlaceholder = js["Chain Covariance Placeholder"].get<std::vector<double>>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Chain Covariance"))
  {
    try
    {
      _chainCovariance = js["Chain Covariance"].get<std::vector<double>>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Rejection Levels"))
  {
    try
    {
      _rejectionLevels = js["Rejection Levels"].get<size_t>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Use Adaptive Sampling"))
  {
    try
    {
      _useAdaptiveSampling = js["Use Adaptive Sampling"].get<int>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Non Adaption Period"))
  {
    try
    {
      _nonAdaptionPeriod = js["Non Adaption Period"].get<size_t>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Chain Covariance Scaling"))
  {
    try
    {
      _chainCovarianceScaling = js["Chain Covariance Scaling"].get<double>();
    } catch (const std::exception& e) {
