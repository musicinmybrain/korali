...
void TMCMC::setConfiguration(knlohmann::json& js) 
{
 ...
 _uniformGenerator->setConfiguration(js["Uniform Generator"]);
  ...
  if (isDefined(js, "Current Burn In"))
  {
    try
    {
      _currentBurnIn = js["Current Burn In"].get<size_t>();
  ...
  if (isDefined(js, "Chain Pending Evaluation"))
  {
    try
    {
      _chainPendingEvaluation = js["Chain Pending Evaluation"].get<std::vector<int>>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Chain Pending Gradient"))
  {
    try
    {
      _chainPendingGradient = js["Chain Pending Gradient"].get<std::vector<int>>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Chain Candidates"))
  {
    try
    {
      _chainCandidates = js["Chain Candidates"].get<std::vector<std::vector<double>>>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Chain Candidates LogLikelihoods"))
  {
    try
    {
      _chainCandidatesLogLikelihoods = js["Chain Candidates LogLikelihoods"].get<std::vector<double>>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Chain Candidates LogPriors"))
  {
    try
    {
      _chainCandidatesLogPriors = js["Chain Candidates LogPriors"].get<std::vector<double>>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Chain Candidates Gradients"))
  {
    try
    {
      _chainCandidatesGradients = js["Chain Candidates Gradients"].get<std::vector<std::vector<double>>>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Chain Candidates Errors"))
  {
    try
    {
      _chainCandidatesErrors = js["Chain Candidates Errors"].get<std::vector<int>>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Chain Candidates Covariance"))
  {
    try
    {
      _chainCandidatesCovariance = js["Chain Candidates Covariance"].get<std::vector<std::vector<double>>>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Chain Leaders"))
  {
    try
    {
      _chainLeaders = js["Chain Leaders"].get<std::vector<std::vector<double>>>();
    } catch (const std::exception& e) {
      KORALI_LOG_ERROR(" + Object: [ TMCMC ] \n + Key:    ['Chain Leaders']\n%s", e.what());
    }
  ...
  if (isDefined(js, "Chain Leaders LogLikelihoods"))
  {
    try
    {
      _chainLeadersLogLikelihoods = js["Chain Leaders LogLikelihoods"].get<std::vector<double>>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Chain Leaders LogPriors"))
  {
    try
    {
      _chainLeadersLogPriors = js["Chain Leaders LogPriors"].get<std::vector<double>>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Chain Leaders Gradients"))
  {
    try
    {
      _chainLeadersGradients = js["Chain Leaders Gradients"].get<std::vector<std::vector<double>>>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Chain Leaders Errors"))
  {
    try
    {
      _chainLeadersErrors = js["Chain Leaders Errors"].get<std::vector<int>>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Chain Leaders Covariance"))
  {
    try
    {
      _chainLeadersCovariance = js["Chain Leaders Covariance"].get<std::vector<std::vector<double>>>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Finished Chains Count"))
  {
    try
    {
      _finishedChainsCount = js["Finished Chains Count"].get<size_t>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Current Chain Step"))
  {
    try
    {
      _currentChainStep = js["Current Chain Step"].get<std::vector<size_t>>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Chain Lengths"))
  {
    try
    {
      _chainLengths = js["Chain Lengths"].get<std::vector<size_t>>();
    } catch (const std::exception& e) {
      KORALI_LOG_ERROR(" + Object: [ TMCMC ] \n + Key:    ['Chain Lengths']\n%s", e.what());
    }
  ...
  if (isDefined(js, "Coefficient Of Variation"))
  {
    try
    {
      _coefficientOfVariation = js["Coefficient Of Variation"].get<double>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Chain Count"))
  {
    try
    {
      _chainCount = js["Chain Count"].get<size_t>();
    } catch (const std::exception& e) {
      KORALI_LOG_ERROR(" + Object: [ TMCMC ] \n + Key:    ['Chain Count']\n%s", e.what());
    }
  ...
  if (isDefined(js, "Annealing Exponent"))
  {
    try
    {
      _annealingExponent = js["Annealing Exponent"].get<double>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Previous Annealing Exponent"))
  {
    try
    {
      _previousAnnealingExponent = js["Previous Annealing Exponent"].get<double>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Num Finite Prior Evaluations"))
  {
    try
    {
      _numFinitePriorEvaluations = js["Num Finite Prior Evaluations"].get<size_t>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Num Finite Likelihood Evaluations"))
  {
    try
    {
      _numFiniteLikelihoodEvaluations = js["Num Finite Likelihood Evaluations"].get<size_t>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Accepted Samples Count"))
  {
    try
    {
      _acceptedSamplesCount = js["Accepted Samples Count"].get<size_t>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Current Accumulated LogEvidence"))
  {
    try
    {
      _currentAccumulatedLogEvidence = js["Current Accumulated LogEvidence"].get<double>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Proposals Acceptance Rate"))
  {
    try
    {
      _proposalsAcceptanceRate = js["Proposals Acceptance Rate"].get<double>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Selection Acceptance Rate"))
  {
    try
    {
      _selectionAcceptanceRate = js["Selection Acceptance Rate"].get<double>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Max Loglikelihood"))
  {
    try
    {
      _maxLoglikelihood = js["Max Loglikelihood"].get<double>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Mean Theta"))
  {
    try
    {
      _meanTheta = js["Mean Theta"].get<std::vector<double>>();
    } catch (const std::exception& e) {
      KORALI_LOG_ERROR(" + Object: [ TMCMC ] \n + Key:    ['Mean Theta']\n%s", e.what());
    }
  ...
  if (isDefined(js, "Sample Database"))
  {
    try
    {
      _sampleDatabase = js["Sample Database"].get<std::vector<std::vector<double>>>();
    } catch (const std::exception& e) {
      KORALI_LOG_ERROR(" + Object: [ TMCMC ] \n + Key:    ['Sample Database']\n%s", e.what());
    }
  ...
  if (isDefined(js, "Sample LogLikelihood Database"))
  {
    try
    {
      _sampleLogLikelihoodDatabase = js["Sample LogLikelihood Database"].get<std::vector<double>>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Sample LogPrior Database"))
  {
    try
    {
      _sampleLogPriorDatabase = js["Sample LogPrior Database"].get<std::vector<double>>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Sample Gradient Database"))
  {
    try
    {
      _sampleGradientDatabase = js["Sample Gradient Database"].get<std::vector<std::vector<double>>>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Sample Error Database"))
  {
    try
    {
      _sampleErrorDatabase = js["Sample Error Database"].get<std::vector<int>>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Sample Covariance Database"))
  {
    try
    {
      _sampleCovarianceDatabase = js["Sample Covariance Database"].get<std::vector<std::vector<double>>>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Upper Extended Boundaries"))
  {
    try
    {
      _upperExtendedBoundaries = js["Upper Extended Boundaries"].get<std::vector<double>>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Lower Extended Boundaries"))
  {
    try
    {
      _lowerExtendedBoundaries = js["Lower Extended Boundaries"].get<std::vector<double>>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Num LU Decomposition Failures Proposal"))
  {
    try
    {
      _numLUDecompositionFailuresProposal = js["Num LU Decomposition Failures Proposal"].get<size_t>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Num Eigen Decomposition Failures Proposal"))
  {
    try
    {
      _numEigenDecompositionFailuresProposal = js["Num Eigen Decomposition Failures Proposal"].get<size_t>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Num Inversion Failures Proposal"))
  {
    try
    {
      _numInversionFailuresProposal = js["Num Inversion Failures Proposal"].get<size_t>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Num Negative Definite Proposals"))
  {
    try
    {
      _numNegativeDefiniteProposals = js["Num Negative Definite Proposals"].get<size_t>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Num Cholesky Decomposition Failures Proposal"))
  {
    try
    {
      _numCholeskyDecompositionFailuresProposal = js["Num Cholesky Decomposition Failures Proposal"].get<size_t>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Num Covariance Corrections"))
  {
    try
    {
      _numCovarianceCorrections = js["Num Covariance Corrections"].get<size_t>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Version"))
  {
    try
    {
      _version = js["Version"].get<std::string>();
    } catch (const std::exception& e) {
      KORALI_LOG_ERROR(" + Object: [ TMCMC ] \n + Key:    ['Version']\n%s", e.what());
    }
      {
  ...
  if (isDefined(js, "Max Chain Length"))
  {
    try
    {
      _maxChainLength = js["Max Chain Length"].get<size_t>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Per Generation Burn In"))
  {
    try
    {
      _perGenerationBurnIn = js["Per Generation Burn In"].get<std::vector<size_t>>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Target Coefficient Of Variation"))
  {
    try
    {
      _targetCoefficientOfVariation = js["Target Coefficient Of Variation"].get<double>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Covariance Scaling"))
  {
    try
    {
      _covarianceScaling = js["Covariance Scaling"].get<double>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Min Annealing Exponent Update"))
  {
    try
    {
      _minAnnealingExponentUpdate = js["Min Annealing Exponent Update"].get<double>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Max Annealing Exponent Update"))
  {
    try
    {
      _maxAnnealingExponentUpdate = js["Max Annealing Exponent Update"].get<double>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Step Size"))
  {
    try
    {
      _stepSize = js["Step Size"].get<double>();
    } catch (const std::exception& e) {
      KORALI_LOG_ERROR(" + Object: [ TMCMC ] \n + Key:    ['Step Size']\n%s", e.what());
    }
  ...
  if (isDefined(js, "Domain Extension Factor"))
  {
    try
    {
      _domainExtensionFactor = js["Domain Extension Factor"].get<double>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Termination Criteria", "Target Annealing Exponent"))
  {
    try
    {
      _targetAnnealingExponent = js["Termination Criteria"]["Target Annealing Exponent"].get<double>();
    } catch (const std::exception& e) {
