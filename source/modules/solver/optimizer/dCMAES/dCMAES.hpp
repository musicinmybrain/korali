...
/** \file
* @brief Header file for module: dCMAES.
*/

/** \dir solver/optimizer/dCMAES
* @brief Contains code, documentation, and scripts for module: dCMAES.
*/
...
/**
* @brief Class declaration for module: dCMAES.
*/
class dCMAES : public Optimizer
{
  public: 
  /**
