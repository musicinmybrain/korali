#include "engine.hpp"
#include "modules/solver/optimizer/dCMAES/dCMAES.hpp"
...
void dCMAES::setInitialConfiguration()
{
...
void dCMAES::initMuWeights(size_t numsamplesmu)
{
...
void dCMAES::checkMeanAndSetRegime()
{
...
void dCMAES::reEvaluateConstraints()
{
  _maxConstraintViolationCount = 0;
...
void dCMAES::updateViabilityBoundaries()
{
  for (size_t c = 0; c < _constraintEvaluations.size(); c++)
  {
    double maxviolation = 0.0;
...
void dCMAES::sampleSingle(size_t sampleIdx, const std::vector<double> &randomNumbers)
{
  for (size_t d = 0; d < _variableCount; ++d)
  {
...
void dCMAES::updateDistribution()
{
...
void dCMAES::numericalErrorTreatment()
{
...
void dCMAES::updateDiscreteMutationMatrix()
{
...
void dCMAES::discretize(std::vector<double> &sample)
{
  for (size_t d = 0; d < _variableCount; ++d)
    if (_k->_variables[d]->_granularity != 0.0)
...
void dCMAES::updateEigensystem(const std::vector<double> &M)
{
...
void dCMAES::eigen(size_t size, const std::vector<double> &M, std::vector<double> &diag, std::vector<double> &Q) const
{
  if (_diagonalCovariance)
  {
...
void dCMAES::sort_index(const std::vector<double> &vec, std::vector<size_t> &sortingIndex, size_t N) const
{
...
void dCMAES::printGenerationBefore() { return; }

void dCMAES::printGenerationAfter()
{
...
void dCMAES::setConfiguration(knlohmann::json& js) 
{
 ...
 { KORALI_LOG_ERROR(" + Object: [ dCMAES ] \n + Key:    ['Is Viability Regime']\n%s", e.what()); } 
 ...
 { KORALI_LOG_ERROR(" + Object: [ dCMAES ] \n + Key:    ['Population Size']\n%s", e.what()); } 
  ...
  else   KORALI_LOG_ERROR(" + No value provided for mandatory setting: ['Population Size'] required by dCMAES.\n"); 
 ...
 { KORALI_LOG_ERROR(" + Object: [ dCMAES ] \n + Key:    ['Mu Value']\n%s", e.what()); } 
  ...
  else   KORALI_LOG_ERROR(" + No value provided for mandatory setting: ['Mu Value'] required by dCMAES.\n"); 
 ...
 { KORALI_LOG_ERROR(" + Object: [ dCMAES ] \n + Key:    ['Mu Type']\n%s", e.what()); } 
{
 ...
 if (validOption == false) KORALI_LOG_ERROR(" + Unrecognized value (%s) provided for mandatory setting: ['Mu Type'] required by dCMAES.\n", _muType.c_str()); 
}
   eraseValue(js, "Mu Type");
 }
  else   KORALI_LOG_ERROR(" + No value provided for mandatory setting: ['Mu Type'] required by dCMAES.\n"); 
 ...
 { KORALI_LOG_ERROR(" + Object: [ dCMAES ] \n + Key:    ['Initial Sigma Cumulation Factor']\n%s", e.what()); } 
  ...
  else   KORALI_LOG_ERROR(" + No value provided for mandatory setting: ['Initial Sigma Cumulation Factor'] required by dCMAES.\n"); 
 ...
 { KORALI_LOG_ERROR(" + Object: [ dCMAES ] \n + Key:    ['Initial Damp Factor']\n%s", e.what()); } 
  ...
  else   KORALI_LOG_ERROR(" + No value provided for mandatory setting: ['Initial Damp Factor'] required by dCMAES.\n"); 
 ...
 { KORALI_LOG_ERROR(" + Object: [ dCMAES ] \n + Key:    ['Use Gradient Information']\n%s", e.what()); } 
  ...
  else   KORALI_LOG_ERROR(" + No value provided for mandatory setting: ['Use Gradient Information'] required by dCMAES.\n"); 
 ...
 { KORALI_LOG_ERROR(" + Object: [ dCMAES ] \n + Key:    ['Gradient Step Size']\n%s", e.what()); } 
  ...
  else   KORALI_LOG_ERROR(" + No value provided for mandatory setting: ['Gradient Step Size'] required by dCMAES.\n"); 
 ...
 { KORALI_LOG_ERROR(" + Object: [ dCMAES ] \n + Key:    ['Is Sigma Bounded']\n%s", e.what()); } 
  ...
  else   KORALI_LOG_ERROR(" + No value provided for mandatory setting: ['Is Sigma Bounded'] required by dCMAES.\n"); 
 ...
 { KORALI_LOG_ERROR(" + Object: [ dCMAES ] \n + Key:    ['Initial Cumulative Covariance']\n%s", e.what()); } 
  ...
  else   KORALI_LOG_ERROR(" + No value provided for mandatory setting: ['Initial Cumulative Covariance'] required by dCMAES.\n"); 
 ...
 { KORALI_LOG_ERROR(" + Object: [ dCMAES ] \n + Key:    ['Diagonal Covariance']\n%s", e.what()); } 
  ...
  else   KORALI_LOG_ERROR(" + No value provided for mandatory setting: ['Diagonal Covariance'] required by dCMAES.\n"); 
 ...
 { KORALI_LOG_ERROR(" + Object: [ dCMAES ] \n + Key:    ['Mirrored Sampling']\n%s", e.what()); } 
  ...
  else   KORALI_LOG_ERROR(" + No value provided for mandatory setting: ['Mirrored Sampling'] required by dCMAES.\n"); 
 ...
 { KORALI_LOG_ERROR(" + Object: [ dCMAES ] \n + Key:    ['Viability Population Size']\n%s", e.what()); } 
  ...
  else   KORALI_LOG_ERROR(" + No value provided for mandatory setting: ['Viability Population Size'] required by dCMAES.\n"); 
 ...
 { KORALI_LOG_ERROR(" + Object: [ dCMAES ] \n + Key:    ['Viability Mu Value']\n%s", e.what()); } 
  ...
  else   KORALI_LOG_ERROR(" + No value provided for mandatory setting: ['Viability Mu Value'] required by dCMAES.\n"); 
 ...
 { KORALI_LOG_ERROR(" + Object: [ dCMAES ] \n + Key:    ['Max Covariance Matrix Corrections']\n%s", e.what()); } 
  ...
  else   KORALI_LOG_ERROR(" + No value provided for mandatory setting: ['Max Covariance Matrix Corrections'] required by dCMAES.\n"); 
 ...
 { KORALI_LOG_ERROR(" + Object: [ dCMAES ] \n + Key:    ['Target Success Rate']\n%s", e.what()); } 
  ...
  else   KORALI_LOG_ERROR(" + No value provided for mandatory setting: ['Target Success Rate'] required by dCMAES.\n"); 
 ...
 { KORALI_LOG_ERROR(" + Object: [ dCMAES ] \n + Key:    ['Covariance Matrix Adaption Strength']\n%s", e.what()); } 
  ...
  else   KORALI_LOG_ERROR(" + No value provided for mandatory setting: ['Covariance Matrix Adaption Strength'] required by dCMAES.\n"); 
 ...
 { KORALI_LOG_ERROR(" + Object: [ dCMAES ] \n + Key:    ['Normal Vector Learning Rate']\n%s", e.what()); } 
  ...
  else   KORALI_LOG_ERROR(" + No value provided for mandatory setting: ['Normal Vector Learning Rate'] required by dCMAES.\n"); 
 ...
 { KORALI_LOG_ERROR(" + Object: [ dCMAES ] \n + Key:    ['Global Success Learning Rate']\n%s", e.what()); } 
  ...
  else   KORALI_LOG_ERROR(" + No value provided for mandatory setting: ['Global Success Learning Rate'] required by dCMAES.\n"); 
 ...
 { KORALI_LOG_ERROR(" + Object: [ dCMAES ] \n + Key:    ['Termination Criteria']['Max Condition Covariance Matrix']\n%s", e.what()); } 
  ...
  else   KORALI_LOG_ERROR(" + No value provided for mandatory setting: ['Termination Criteria']['Max Condition Covariance Matrix'] required by dCMAES.\n"); 
 ...
 { KORALI_LOG_ERROR(" + Object: [ dCMAES ] \n + Key:    ['Termination Criteria']['Min Standard Deviation']\n%s", e.what()); } 
  ...
  else   KORALI_LOG_ERROR(" + No value provided for mandatory setting: ['Termination Criteria']['Min Standard Deviation'] required by dCMAES.\n"); 
 ...
 { KORALI_LOG_ERROR(" + Object: [ dCMAES ] \n + Key:    ['Termination Criteria']['Max Standard Deviation']\n%s", e.what()); } 
  ...
  else   KORALI_LOG_ERROR(" + No value provided for mandatory setting: ['Termination Criteria']['Max Standard Deviation'] required by dCMAES.\n"); 
 ...
 { KORALI_LOG_ERROR(" + Object: [ dCMAES ] \n + Key:    ['Granularity']\n%s", e.what()); } 
  ...
  else   KORALI_LOG_ERROR(" + No value provided for mandatory setting: ['Granularity'] required by dCMAES.\n"); 

 } 
 Optimizer::setConfiguration(js);
 _type = "optimizer/dCMAES";
 if(isDefined(js, "Type")) eraseValue(js, "Type");
 if(isEmpty(js) == false) KORALI_LOG_ERROR(" + Unrecognized settings for Korali module: dCMAES: \n%s\n", js.dump(2).c_str());
} 

void dCMAES::getConfiguration(knlohmann::json& js) 
{
...
void dCMAES::applyModuleDefaults(knlohmann::json& js) 
{
...
void dCMAES::applyVariableDefaults() 
{
...
bool dCMAES::checkTermination()
{
 bool hasFinished = false;

 if (_k->_currentGeneration > 1 && (_maximumCovarianceEigenvalue >= _maxConditionCovarianceMatrix * _minimumCovarianceEigenvalue))
 {
  _terminationCriteria.push_back("dCMAES['Max Condition Covariance Matrix'] = " + std::to_string(_maxConditionCovarianceMatrix) + ".");
  hasFinished = true;
 }

 if (_k->_currentGeneration > 1 && (_currentMinStandardDeviation <= _minStandardDeviation))
 {
  _terminationCriteria.push_back("dCMAES['Min Standard Deviation'] = " + std::to_string(_minStandardDeviation) + ".");
  hasFinished = true;
 }

 if (_k->_currentGeneration > 1 && (_currentMaxStandardDeviation >= _maxStandardDeviation))
 {
  _terminationCriteria.push_back("dCMAES['Max Standard Deviation'] = " + std::to_string(_maxStandardDeviation) + ".");
  hasFinished = true;
 }
