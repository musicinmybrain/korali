...
void CMAES::setConfiguration(knlohmann::json& js) 
{
 ...
 _uniformGenerator->setConfiguration(js["Uniform Generator"]);
  ...
  if (isDefined(js, "Is Viability Regime"))
  {
    try
    {
      _isViabilityRegime = js["Is Viability Regime"].get<int>();
  ...
  if (isDefined(js, "Value Vector"))
  {
    try
    {
      _valueVector = js["Value Vector"].get<std::vector<double>>();
    } catch (const std::exception& e) {
      KORALI_LOG_ERROR(" + Object: [ CMAES ] \n + Key:    ['Value Vector']\n%s", e.what());
    }
  ...
  if (isDefined(js, "Gradients"))
  {
    try
    {
      _gradients = js["Gradients"].get<std::vector<std::vector<double>>>();
    } catch (const std::exception& e) {
      KORALI_LOG_ERROR(" + Object: [ CMAES ] \n + Key:    ['Gradients']\n%s", e.what());
    }
  ...
  if (isDefined(js, "Current Population Size"))
  {
    try
    {
      _currentPopulationSize = js["Current Population Size"].get<size_t>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Current Mu Value"))
  {
    try
    {
      _currentMuValue = js["Current Mu Value"].get<size_t>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Mu Weights"))
  {
    try
    {
      _muWeights = js["Mu Weights"].get<std::vector<double>>();
    } catch (const std::exception& e) {
      KORALI_LOG_ERROR(" + Object: [ CMAES ] \n + Key:    ['Mu Weights']\n%s", e.what());
    }
  ...
  if (isDefined(js, "Effective Mu"))
  {
    try
    {
      _effectiveMu = js["Effective Mu"].get<double>();
    } catch (const std::exception& e) {
      KORALI_LOG_ERROR(" + Object: [ CMAES ] \n + Key:    ['Effective Mu']\n%s", e.what());
    }
  ...
  if (isDefined(js, "Sigma Cumulation Factor"))
  {
    try
    {
      _sigmaCumulationFactor = js["Sigma Cumulation Factor"].get<double>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Damp Factor"))
  {
    try
    {
      _dampFactor = js["Damp Factor"].get<double>();
    } catch (const std::exception& e) {
      KORALI_LOG_ERROR(" + Object: [ CMAES ] \n + Key:    ['Damp Factor']\n%s", e.what());
    }
  ...
  if (isDefined(js, "Cumulative Covariance"))
  {
    try
    {
      _cumulativeCovariance = js["Cumulative Covariance"].get<double>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Chi Square Number"))
  {
    try
    {
      _chiSquareNumber = js["Chi Square Number"].get<double>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Covariance Eigenvalue Evaluation Frequency"))
  {
    try
    {
      _covarianceEigenvalueEvaluationFrequency = js["Covariance Eigenvalue Evaluation Frequency"].get<size_t>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Sample Population"))
  {
    try
    {
      _samplePopulation = js["Sample Population"].get<std::vector<std::vector<double>>>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Finished Sample Count"))
  {
    try
    {
      _finishedSampleCount = js["Finished Sample Count"].get<size_t>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Current Best Variables"))
  {
    try
    {
      _currentBestVariables = js["Current Best Variables"].get<std::vector<double>>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Previous Best Value"))
  {
    try
    {
      _previousBestValue = js["Previous Best Value"].get<double>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Previous Best Ever Value"))
  {
    try
    {
      _previousBestEverValue = js["Previous Best Ever Value"].get<double>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Sorting Index"))
  {
    try
    {
      _sortingIndex = js["Sorting Index"].get<std::vector<size_t>>();
    } catch (const std::exception& e) {
      KORALI_LOG_ERROR(" + Object: [ CMAES ] \n + Key:    ['Sorting Index']\n%s", e.what());
    }
  ...
  if (isDefined(js, "Covariance Matrix"))
  {
    try
    {
      _covarianceMatrix = js["Covariance Matrix"].get<std::vector<double>>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Auxiliar Covariance Matrix"))
  {
    try
    {
      _auxiliarCovarianceMatrix = js["Auxiliar Covariance Matrix"].get<std::vector<double>>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Covariance Eigenvector Matrix"))
  {
    try
    {
      _covarianceEigenvectorMatrix = js["Covariance Eigenvector Matrix"].get<std::vector<double>>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Auxiliar Covariance Eigenvector Matrix"))
  {
    try
    {
      _auxiliarCovarianceEigenvectorMatrix = js["Auxiliar Covariance Eigenvector Matrix"].get<std::vector<double>>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Axis Lengths"))
  {
    try
    {
      _axisLengths = js["Axis Lengths"].get<std::vector<double>>();
    } catch (const std::exception& e) {
      KORALI_LOG_ERROR(" + Object: [ CMAES ] \n + Key:    ['Axis Lengths']\n%s", e.what());
    }
  ...
  if (isDefined(js, "Auxiliar Axis Lengths"))
  {
    try
    {
      _auxiliarAxisLengths = js["Auxiliar Axis Lengths"].get<std::vector<double>>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "BDZ Matrix"))
  {
    try
    {
      _bDZMatrix = js["BDZ Matrix"].get<std::vector<double>>();
    } catch (const std::exception& e) {
      KORALI_LOG_ERROR(" + Object: [ CMAES ] \n + Key:    ['BDZ Matrix']\n%s", e.what());
    }
  ...
  if (isDefined(js, "Auxiliar BDZ Matrix"))
  {
    try
    {
      _auxiliarBDZMatrix = js["Auxiliar BDZ Matrix"].get<std::vector<double>>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Current Mean"))
  {
    try
    {
      _currentMean = js["Current Mean"].get<std::vector<double>>();
    } catch (const std::exception& e) {
      KORALI_LOG_ERROR(" + Object: [ CMAES ] \n + Key:    ['Current Mean']\n%s", e.what());
    }
  ...
  if (isDefined(js, "Previous Mean"))
  {
    try
    {
      _previousMean = js["Previous Mean"].get<std::vector<double>>();
    } catch (const std::exception& e) {
      KORALI_LOG_ERROR(" + Object: [ CMAES ] \n + Key:    ['Previous Mean']\n%s", e.what());
    }
  ...
  if (isDefined(js, "Mean Update"))
  {
    try
    {
      _meanUpdate = js["Mean Update"].get<std::vector<double>>();
    } catch (const std::exception& e) {
      KORALI_LOG_ERROR(" + Object: [ CMAES ] \n + Key:    ['Mean Update']\n%s", e.what());
    }
  ...
  if (isDefined(js, "Evolution Path"))
  {
    try
    {
      _evolutionPath = js["Evolution Path"].get<std::vector<double>>();
    } catch (const std::exception& e) {
      KORALI_LOG_ERROR(" + Object: [ CMAES ] \n + Key:    ['Evolution Path']\n%s", e.what());
    }
  ...
  if (isDefined(js, "Conjugate Evolution Path"))
  {
    try
    {
      _conjugateEvolutionPath = js["Conjugate Evolution Path"].get<std::vector<double>>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Conjugate Evolution Path L2 Norm"))
  {
    try
    {
      _conjugateEvolutionPathL2Norm = js["Conjugate Evolution Path L2 Norm"].get<double>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Infeasible Sample Count"))
  {
    try
    {
      _infeasibleSampleCount = js["Infeasible Sample Count"].get<size_t>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Maximum Diagonal Covariance Matrix Element"))
  {
    try
    {
      _maximumDiagonalCovarianceMatrixElement = js["Maximum Diagonal Covariance Matrix Element"].get<double>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Minimum Diagonal Covariance Matrix Element"))
  {
    try
    {
      _minimumDiagonalCovarianceMatrixElement = js["Minimum Diagonal Covariance Matrix Element"].get<double>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Maximum Covariance Eigenvalue"))
  {
    try
    {
      _maximumCovarianceEigenvalue = js["Maximum Covariance Eigenvalue"].get<double>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Minimum Covariance Eigenvalue"))
  {
    try
    {
      _minimumCovarianceEigenvalue = js["Minimum Covariance Eigenvalue"].get<double>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Is Eigensystem Updated"))
  {
    try
    {
      _isEigensystemUpdated = js["Is Eigensystem Updated"].get<int>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Viability Indicator"))
  {
    try
    {
      _viabilityIndicator = js["Viability Indicator"].get<std::vector<std::vector<int>>>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Has Constraints"))
  {
    try
    {
      _hasConstraints = js["Has Constraints"].get<int>();
    } catch (const std::exception& e) {
      KORALI_LOG_ERROR(" + Object: [ CMAES ] \n + Key:    ['Has Constraints']\n%s", e.what());
    }
  ...
  if (isDefined(js, "Covariance Matrix Adaption Factor"))
  {
    try
    {
      _covarianceMatrixAdaptionFactor = js["Covariance Matrix Adaption Factor"].get<double>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Best Valid Sample"))
  {
    try
    {
      _bestValidSample = js["Best Valid Sample"].get<int>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Global Success Rate"))
  {
    try
    {
      _globalSuccessRate = js["Global Success Rate"].get<double>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Viability Function Value"))
  {
    try
    {
      _viabilityFunctionValue = js["Viability Function Value"].get<double>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Resampled Parameter Count"))
  {
    try
    {
      _resampledParameterCount = js["Resampled Parameter Count"].get<size_t>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Covariance Matrix Adaptation Count"))
  {
    try
    {
      _covarianceMatrixAdaptationCount = js["Covariance Matrix Adaptation Count"].get<size_t>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Viability Boundaries"))
  {
    try
    {
      _viabilityBoundaries = js["Viability Boundaries"].get<std::vector<double>>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Viability Improvement"))
  {
    try
    {
      _viabilityImprovement = js["Viability Improvement"].get<std::vector<int>>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Max Constraint Violation Count"))
  {
    try
    {
      _maxConstraintViolationCount = js["Max Constraint Violation Count"].get<size_t>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Sample Constraint Violation Counts"))
  {
    try
    {
      _sampleConstraintViolationCounts = js["Sample Constraint Violation Counts"].get<std::vector<size_t>>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Constraint Evaluations"))
  {
    try
    {
      _constraintEvaluations = js["Constraint Evaluations"].get<std::vector<std::vector<double>>>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Normal Constraint Approximation"))
  {
    try
    {
      _normalConstraintApproximation = js["Normal Constraint Approximation"].get<std::vector<std::vector<double>>>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Best Constraint Evaluations"))
  {
    try
    {
      _bestConstraintEvaluations = js["Best Constraint Evaluations"].get<std::vector<double>>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Has Discrete Variables"))
  {
    try
    {
      _hasDiscreteVariables = js["Has Discrete Variables"].get<int>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Discrete Mutations"))
  {
    try
    {
      _discreteMutations = js["Discrete Mutations"].get<std::vector<double>>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Number Of Discrete Mutations"))
  {
    try
    {
      _numberOfDiscreteMutations = js["Number Of Discrete Mutations"].get<size_t>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Number Masking Matrix Entries"))
  {
    try
    {
      _numberMaskingMatrixEntries = js["Number Masking Matrix Entries"].get<size_t>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Masking Matrix"))
  {
    try
    {
      _maskingMatrix = js["Masking Matrix"].get<std::vector<double>>();
    } catch (const std::exception& e) {
      KORALI_LOG_ERROR(" + Object: [ CMAES ] \n + Key:    ['Masking Matrix']\n%s", e.what());
    }
  ...
  if (isDefined(js, "Masking Matrix Sigma"))
  {
    try
    {
      _maskingMatrixSigma = js["Masking Matrix Sigma"].get<std::vector<double>>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Chi Square Number Discrete Mutations"))
  {
    try
    {
      _chiSquareNumberDiscreteMutations = js["Chi Square Number Discrete Mutations"].get<double>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Current Min Standard Deviation"))
  {
    try
    {
      _currentMinStandardDeviation = js["Current Min Standard Deviation"].get<double>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Current Max Standard Deviation"))
  {
    try
    {
      _currentMaxStandardDeviation = js["Current Max Standard Deviation"].get<double>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Constraint Evaluation Count"))
  {
    try
    {
      _constraintEvaluationCount = js["Constraint Evaluation Count"].get<size_t>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Population Size"))
  {
    try
    {
      _populationSize = js["Population Size"].get<size_t>();
    } catch (const std::exception& e) {
      KORALI_LOG_ERROR(" + Object: [ CMAES ] \n + Key:    ['Population Size']\n%s", e.what());
    }
  ...
  if (isDefined(js, "Mu Value"))
  {
    try
    {
      _muValue = js["Mu Value"].get<size_t>();
    } catch (const std::exception& e) {
      KORALI_LOG_ERROR(" + Object: [ CMAES ] \n + Key:    ['Mu Value']\n%s", e.what());
    }
  ...
  if (isDefined(js, "Mu Type"))
  {
    try
    {
      _muType = js["Mu Type"].get<std::string>();
    } catch (const std::exception& e) {
      KORALI_LOG_ERROR(" + Object: [ CMAES ] \n + Key:    ['Mu Type']\n%s", e.what());
    }
      {
  ...
  if (isDefined(js, "Initial Sigma Cumulation Factor"))
  {
    try
    {
      _initialSigmaCumulationFactor = js["Initial Sigma Cumulation Factor"].get<double>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Initial Damp Factor"))
  {
    try
    {
      _initialDampFactor = js["Initial Damp Factor"].get<double>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Use Gradient Information"))
  {
    try
    {
      _useGradientInformation = js["Use Gradient Information"].get<int>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Gradient Step Size"))
  {
    try
    {
      _gradientStepSize = js["Gradient Step Size"].get<float>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Is Sigma Bounded"))
  {
    try
    {
      _isSigmaBounded = js["Is Sigma Bounded"].get<int>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Initial Cumulative Covariance"))
  {
    try
    {
      _initialCumulativeCovariance = js["Initial Cumulative Covariance"].get<double>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Diagonal Covariance"))
  {
    try
    {
      _diagonalCovariance = js["Diagonal Covariance"].get<int>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Mirrored Sampling"))
  {
    try
    {
      _mirroredSampling = js["Mirrored Sampling"].get<int>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Viability Population Size"))
  {
    try
    {
      _viabilityPopulationSize = js["Viability Population Size"].get<size_t>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Viability Mu Value"))
  {
    try
    {
      _viabilityMuValue = js["Viability Mu Value"].get<size_t>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Max Covariance Matrix Corrections"))
  {
    try
    {
      _maxCovarianceMatrixCorrections = js["Max Covariance Matrix Corrections"].get<size_t>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Target Success Rate"))
  {
    try
    {
      _targetSuccessRate = js["Target Success Rate"].get<double>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Covariance Matrix Adaption Strength"))
  {
    try
    {
      _covarianceMatrixAdaptionStrength = js["Covariance Matrix Adaption Strength"].get<double>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Normal Vector Learning Rate"))
  {
    try
    {
      _normalVectorLearningRate = js["Normal Vector Learning Rate"].get<double>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Global Success Learning Rate"))
  {
    try
    {
      _globalSuccessLearningRate = js["Global Success Learning Rate"].get<double>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Termination Criteria", "Max Infeasible Resamplings"))
  {
    try
    {
      _maxInfeasibleResamplings = js["Termination Criteria"]["Max Infeasible Resamplings"].get<size_t>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Termination Criteria", "Max Condition Covariance Matrix"))
  {
    try
    {
      _maxConditionCovarianceMatrix = js["Termination Criteria"]["Max Condition Covariance Matrix"].get<double>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Termination Criteria", "Min Standard Deviation"))
  {
    try
    {
      _minStandardDeviation = js["Termination Criteria"]["Min Standard Deviation"].get<double>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Termination Criteria", "Max Standard Deviation"))
  {
    try
    {
      _maxStandardDeviation = js["Termination Criteria"]["Max Standard Deviation"].get<double>();
    } catch (const std::exception& e) {
 ...
 for (size_t i = 0; i < _k->_js["Variables"].size(); i++) { 
  if (isDefined(_k->_js["Variables"][i], "Granularity"))
  {
    try
    {
      _k->_variables[i]->_granularity = _k->_js["Variables"][i]["Granularity"].get<double>();
    } catch (const std::exception& e) {
      KORALI_LOG_ERROR(" + Object: [ CMAES ] \n + Key:    ['Granularity']\n%s", e.what());
    }
