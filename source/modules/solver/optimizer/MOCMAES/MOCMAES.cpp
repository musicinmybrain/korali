...
void MOCMAES::setConfiguration(knlohmann::json& js) 
{
  ...
  if (isDefined(js, "Num Objectives"))
  {
    try
    {
      _numObjectives = js["Num Objectives"].get<size_t>();
 ...
 _uniformGenerator->setConfiguration(js["Uniform Generator"]);
  ...
  if (isDefined(js, "Current Non Dominated Sample Count"))
  {
    try
    {
      _currentNonDominatedSampleCount = js["Current Non Dominated Sample Count"].get<size_t>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Current Values"))
  {
    try
    {
      _currentValues = js["Current Values"].get<std::vector<std::vector<double>>>();
    } catch (const std::exception& e) {
      KORALI_LOG_ERROR(" + Object: [ MOCMAES ] \n + Key:    ['Current Values']\n%s", e.what());
    }
  ...
  if (isDefined(js, "Previous Values"))
  {
    try
    {
      _previousValues = js["Previous Values"].get<std::vector<std::vector<double>>>();
    } catch (const std::exception& e) {
      KORALI_LOG_ERROR(" + Object: [ MOCMAES ] \n + Key:    ['Previous Values']\n%s", e.what());
    }
  ...
  if (isDefined(js, "Parent Index"))
  {
    try
    {
      _parentIndex = js["Parent Index"].get<std::vector<size_t>>();
    } catch (const std::exception& e) {
      KORALI_LOG_ERROR(" + Object: [ MOCMAES ] \n + Key:    ['Parent Index']\n%s", e.what());
    }
  ...
  if (isDefined(js, "Parent Sample Population"))
  {
    try
    {
      _parentSamplePopulation = js["Parent Sample Population"].get<std::vector<std::vector<double>>>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Current Sample Population"))
  {
    try
    {
      _currentSamplePopulation = js["Current Sample Population"].get<std::vector<std::vector<double>>>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Previous Sample Population"))
  {
    try
    {
      _previousSamplePopulation = js["Previous Sample Population"].get<std::vector<std::vector<double>>>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Parent Sigma"))
  {
    try
    {
      _parentSigma = js["Parent Sigma"].get<std::vector<double>>();
    } catch (const std::exception& e) {
      KORALI_LOG_ERROR(" + Object: [ MOCMAES ] \n + Key:    ['Parent Sigma']\n%s", e.what());
    }
  ...
  if (isDefined(js, "Current Sigma"))
  {
    try
    {
      _currentSigma = js["Current Sigma"].get<std::vector<double>>();
    } catch (const std::exception& e) {
      KORALI_LOG_ERROR(" + Object: [ MOCMAES ] \n + Key:    ['Current Sigma']\n%s", e.what());
    }
  ...
  if (isDefined(js, "Previous Sigma"))
  {
    try
    {
      _previousSigma = js["Previous Sigma"].get<std::vector<double>>();
    } catch (const std::exception& e) {
      KORALI_LOG_ERROR(" + Object: [ MOCMAES ] \n + Key:    ['Previous Sigma']\n%s", e.what());
    }
  ...
  if (isDefined(js, "Parent Covariance Matrix"))
  {
    try
    {
      _parentCovarianceMatrix = js["Parent Covariance Matrix"].get<std::vector<std::vector<double>>>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Current Covariance Matrix"))
  {
    try
    {
      _currentCovarianceMatrix = js["Current Covariance Matrix"].get<std::vector<std::vector<double>>>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Previous Covariance Matrix"))
  {
    try
    {
      _previousCovarianceMatrix = js["Previous Covariance Matrix"].get<std::vector<std::vector<double>>>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Parent Evolution Paths"))
  {
    try
    {
      _parentEvolutionPaths = js["Parent Evolution Paths"].get<std::vector<std::vector<double>>>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Current Evolution Paths"))
  {
    try
    {
      _currentEvolutionPaths = js["Current Evolution Paths"].get<std::vector<std::vector<double>>>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Previous Evolution Paths"))
  {
    try
    {
      _previousEvolutionPaths = js["Previous Evolution Paths"].get<std::vector<std::vector<double>>>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Parent Success Probabilities"))
  {
    try
    {
      _parentSuccessProbabilities = js["Parent Success Probabilities"].get<std::vector<double>>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Current Success Probabilities"))
  {
    try
    {
      _currentSuccessProbabilities = js["Current Success Probabilities"].get<std::vector<double>>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Previous Success Probabilities"))
  {
    try
    {
      _previousSuccessProbabilities = js["Previous Success Probabilities"].get<std::vector<double>>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Best Ever Values"))
  {
    try
    {
      _bestEverValues = js["Best Ever Values"].get<std::vector<double>>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Best Ever Variables Vector"))
  {
    try
    {
      _bestEverVariablesVector = js["Best Ever Variables Vector"].get<std::vector<std::vector<double>>>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Previous Best Values"))
  {
    try
    {
      _previousBestValues = js["Previous Best Values"].get<std::vector<double>>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Previous Best Variables Vector"))
  {
    try
    {
      _previousBestVariablesVector = js["Previous Best Variables Vector"].get<std::vector<std::vector<double>>>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Current Best Values"))
  {
    try
    {
      _currentBestValues = js["Current Best Values"].get<std::vector<double>>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Current Best Variables Vector"))
  {
    try
    {
      _currentBestVariablesVector = js["Current Best Variables Vector"].get<std::vector<std::vector<double>>>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Sample Collection"))
  {
    try
    {
      _sampleCollection = js["Sample Collection"].get<std::vector<std::vector<double>>>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Sample Value Collection"))
  {
    try
    {
      _sampleValueCollection = js["Sample Value Collection"].get<std::vector<std::vector<double>>>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Current Best Value Differences"))
  {
    try
    {
      _currentBestValueDifferences = js["Current Best Value Differences"].get<std::vector<double>>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Current Best Variable Differences"))
  {
    try
    {
      _currentBestVariableDifferences = js["Current Best Variable Differences"].get<std::vector<double>>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Current Min Standard Deviations"))
  {
    try
    {
      _currentMinStandardDeviations = js["Current Min Standard Deviations"].get<std::vector<double>>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Current Max Standard Deviations"))
  {
    try
    {
      _currentMaxStandardDeviations = js["Current Max Standard Deviations"].get<std::vector<double>>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Evolution Path Adaption Strength"))
  {
    try
    {
      _evolutionPathAdaptionStrength = js["Evolution Path Adaption Strength"].get<double>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Covariance Learning Rate"))
  {
    try
    {
      _covarianceLearningRate = js["Covariance Learning Rate"].get<double>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Threshold Probability"))
  {
    try
    {
      _thresholdProbability = js["Threshold Probability"].get<double>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Success Learning Rate"))
  {
    try
    {
      _successLearningRate = js["Success Learning Rate"].get<double>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Termination Criteria", "Min Max Value Difference Threshold"))
  {
    try
    {
      _minMaxValueDifferenceThreshold = js["Termination Criteria"]["Min Max Value Difference Threshold"].get<double>();
    } catch (const std::exception& e) {
  ...
  if (isDefined(js, "Termination Criteria", "Min Variable Difference Threshold"))
  {
    try
    {
      _minVariableDifferenceThreshold = js["Termination Criteria"]["Min Variable Difference Threshold"].get<double>();
    } catch (const std::exception& e) {
