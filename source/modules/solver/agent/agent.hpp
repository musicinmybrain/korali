...
class Agent : public Solver
{
  ...
  */
   std::vector<std::vector<float>> _featureRescalingMeans;
  /**
  * @brief [Internal Use] Standard deviation of features during exploration phase.
  */
   std::vector<std::vector<float>> _featureRescalingSigmas;
  /**
  ...
  */
  ...
  std::vector<std::vector<std::vector<std::vector<float>>>> _backgroundTrajectoryStates;
  std::vector<std::vector<std::vector<std::vector<float>>>> _backgroundTrajectoryActions;
  std::vector<std::vector<std::vector<std::vector<float>>>> _backgroundTrajectoryFeatures;
  ...
  */
  virtual float evaluateTrajectoryLogProbability(const std::vector<std::vector<std::vector<float>>> &states, const std::vector<std::vector<std::vector<float>>> &actions, const std::vector<float> &policyHyperparameter) = 0;
  ...
  * @return The log probability of the trajectory.
  */
  virtual float evaluateTrajectoryLogProbabilityWithObservedPolicy(const std::vector<std::vector<std::vector<float>>> &states, const std::vector<std::vector<std::vector<float>>> &actions) = 0;
